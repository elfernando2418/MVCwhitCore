...
<form class="row g-3" method="POST" action="index.php?view=addLote_controlador">
    <div class="col-md-12" style="max-width: 500px;">
        ...
        <div class="col-md-12 mt-1">
            ...
            <input type="text" class="form-control" id="codigo" value="<?php echo $materia->codigo  ?>">
        </div>
        <div class="col-md-12 mt-1">
            <label for="id_tipo_mateira" class="form-label">Tipo de Materia</label>
            <input type="text" class="form-control" id="id_tipo_mateira" value="<?php echo $materia->id_tipo_mateira  ?>">
        </div>
        <div class="col-md-12 mt-1">
            <label for="cantidad" class="form-label">Cantidad</label>
            <input type="number" class="form-control" id="cantidad" value="<?php echo $materia->cantidad  ?>">
        </div>
